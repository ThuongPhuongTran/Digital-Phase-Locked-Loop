...
void ADC1_Configuration(void)
{
  ...
  /* Configure ADC1 Channel 1,2,3,6,7 pins as analog input ******************************/
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1| GPIO_Pin_2| GPIO_Pin_3| GPIO_Pin_6| GPIO_Pin_7| GPIO_Pin_8;
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AN;
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_NOPULL;
  GPIO_Init(GPIOA, &GPIO_InitStructure);
  ...
  ADC_RegularChannelConfig(ADC1, ADC_Channel_1, 1, ADC_SampleTime_3Cycles);//480Cycles); // PA1
  ADC_RegularChannelConfig(ADC1, ADC_Channel_2, 2, ADC_SampleTime_3Cycles);//480Cycles); // PA2
  ADC_RegularChannelConfig(ADC1, ADC_Channel_3, 3, ADC_SampleTime_3Cycles);//480Cycles); // PA3
  ADC_RegularChannelConfig(ADC1, ADC_Channel_6, 4, ADC_SampleTime_3Cycles);//480Cycles); // PA6
  ADC_RegularChannelConfig(ADC1, ADC_Channel_7, 5, ADC_SampleTime_3Cycles);//480Cycles); // PA7
  ADC_RegularChannelConfig(ADC1, ADC_Channel_8, 6, ADC_SampleTime_3Cycles);//480Cycles); // PA0
